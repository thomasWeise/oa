...
\rel.figure{points_vs_lines}{"End results" experiments with algorithms versus how the algorithms could actually have performed.}{points_vs_lines.svgz}{width=84%}
...
\rel.figure{performance_cuts}{Different algorithms may perform best at different points in time.}{performance_cuts.svgz}{width=74%}
