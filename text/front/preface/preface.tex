\section*{Preface}%
%
After writing ``\citetitle{W2009GOATAA}''~\cite{W2009GOATAA} during my time as PhD student a long time ago, I now want to write a more practical guide to \indexi{optimization} and \indexi{metaheuristics}.
...
It tries to provide an intuition about how optimization algorithms work in practice, what things to look for when solving a problem, and how to get from a simple, working, ``\indexi{proof-of-concept}'' approach to an efficient solution for a given problem.
We follow a ``\indexi{learning-by-doing}'' approach by trying to solve one practical optimization problem as example theme throughout the book.
...
We use concrete examples and algorithm implementations written in \href{https://python.org}{Python}\index{Python}.
These are freely available at \url{\moptipyUrl}\index{moptipy} under the GNU GENERAL PUBLIC LICENSE Version~3, 29~June~2007\index{GPL~3}.
...
In order to fully understand the code examples, we recommend the reader to familiarize themselves with \href{https://python.org}{Python}\index{Python}, \href{https://numpy.org/}{numpy}\index{numpy}, and \href{https://matplotlib.org/}{matplotlib}\index{matplotlib}.
...
This book is released under the \emph{Attribution-NonCommercial-ShareAlike~4.0 International license} (\href{http://creativecommons.org/licenses/by-nc-sa/4.0/}{\mbox{CC~BY-NC-SA~4.0}})\index{CC~BY-NC-SA~4.0}.
