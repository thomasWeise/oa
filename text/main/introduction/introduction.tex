...
They control \indexi{advertisement} campaigns and suggest \indexi{product pricing} policies~\cite{MAM2021TROAIRWAFRAMG}.
They support us by suggesting good decisions in a variety of fields, ranging from \indexi{engineering}, timetabling and \indexi{scheduling}, product design, to logistic planning\index{logistics}.
They will be the most important element of the transition of our industry to smarter manufacturing\index{smart manufacturing} and \indexi{intelligent production}, where they can automate a variety of tasks, as illustrated in \autoref{fig:intelligent_manufacturing}.
...
\index{optimization}\index{smart manufacturing}%
\label{fig:intelligent_manufacturing}%
\end{figure}%

Optimization and \indexi{Operations Research} provide us with algorithms that propose good solutions to a very wide range of questions.
...
%
\item All branches of \indexi{industry}, all service sectors, as well as cities and regions face both global and local competition.
