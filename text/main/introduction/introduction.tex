...
%
Algorithms influence a bigger and bigger part of both of our daily, private, and work life.
They suggest interesting movies for us to watch or products to purchase.
They help us find efficient routes when driving by car or match us to the next available nearby taxi.
...
\begin{figure}%
\centering%
\includegraphics[width=0.99\linewidth,trim={2cm 0pt 0pt 0pt},clip]{\currentDir/intelligent_manufacturing}%
\caption{%
...
Optimization and \pgls{fieldOR} provide us with algorithms that propose good solutions to a very wide range of questions.
