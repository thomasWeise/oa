...
%
There are both dynamic and static aspects of \indexi{intelligent production}, as well as all sorts of nuances in between.
...
This scenario is called \emph{quadratic assignment problem\index{Quadratic Assignment Problem}}~(\indexi{QAP})~\cite{BCPP1998TQAP}.
