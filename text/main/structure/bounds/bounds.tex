...
Furthermore, our experiment \href{\moptipyUrl/moptipy.api.html#module-moptipy.api.execution}{execution API} will automatically stop the optimization processes if a solution~$\globalOptimumOf{\solspel}$ with~$\objfOf{\globalOptimumOf{\solspel}}=\lowerBoundOf{\objf}$ is reached.%
\endhsection%
%
