...
这本书试图以一种容易理解的方式为没有该领域背景的本科生和研究生的读者介绍优化。
这本书试图提供一个关于优化算法如何在实践中工作的直觉。
这本书让你知道在解决问题时应该寻找什么东西。
这本书讨论了如何从一个简单的、可工作的、概念证明的方法获得一个给定问题的有效解决方案。
...
| 网站: <http://iao.hfuu.edu.cn/team/director>
